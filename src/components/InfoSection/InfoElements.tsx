...
export const InfoContainer = styled(
  ({ dark, imgStart, ...props }: StyledProps<"div", Props>) => (
    <div {...props} />
  )
)`
...
export const Heading = styled(
  ({ dark, imgStart, ...props }: StyledProps<"h1", Props>) => <h1 {...props} />
)`
  margin-bottom: 24px;
  font-size: 48px;
  line-height: 1.1;
...
export const Subtitle = styled(
  ({ dark, imgStart, ...props }: StyledProps<"p", Props>) => <p {...props} />
)`
  max-width: 440px;
  margin-bottom: 35px;
  font-size: 18px;
