...
import { LinkProps, Link as LinkS } from "react-scroll";

const StyledLinkS = styled(({ to, ref, ...props }: LinkProps) => (
  <LinkS to={to} {...props} />
))`
...
export const Nav = styled(
  ({ scrollNav, ...props }: StyledProps<"nav", { scrollNav: boolean }>) => (
    <nav {...props} />
  )
)`
...
export const NavLinks = styled(StyledLinkS)`
  color: #fff;
  display: flex;
  align-items: center;
  text-decoration: none;
